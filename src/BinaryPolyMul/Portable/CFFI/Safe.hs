...
module BinaryPolyMul.Portable.CFFI.Safe where
import Data.Word
...
foreign import ccall safe "binaryPolyMul_portable_ptr"
...
foreign import ccall safe "binaryPolyMul_portable_lo"
  c_binaryPolyMul_portable_lo :: Word64 -> Word64 -> Word64

foreign import ccall safe "binaryPolyMul_portable_hi"
