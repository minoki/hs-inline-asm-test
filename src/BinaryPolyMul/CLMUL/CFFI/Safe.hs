...
module BinaryPolyMul.CLMUL.CFFI.Safe where
...
foreign import ccall safe "binaryPolyMul_clmul_ptr"
...
binaryPolyMulWithPtr !a !b = unsafePerformIO $ do
  Marshal.alloca $ \outHigh -> do
    lo <- c_binaryPolyMul_clmul_ptr a b outHigh
    hi <- peek outHigh
...
foreign import ccall safe "binaryPolyMul_clmul_lo"
  c_binaryPolyMul_clmul_lo :: Word64 -> Word64 -> Word64

foreign import ccall safe "binaryPolyMul_clmul_hi"
  c_binaryPolyMul_clmul_hi :: Word64 -> Word64 -> Word64
...
foreign import ccall safe "binaryPolyMul_clmul_xmm"
