...
main = do
  ...
  putStrLn $ showHex (WM.CFFI.Safe.wideningMulXMM 0xdeadbeef12345678 0xc0ffee1234567890) ""
  ...
  putStrLn $ showHex (WM.CFFI.Unsafe.wideningMulXMM 0xdeadbeef12345678 0xc0ffee1234567890) ""
  ...
  putStrLn $ showHex (WM.Prim.wideningMulXMM 0xdeadbeef12345678 0xc0ffee1234567890) ""
  ...
  putStrLn $ showHex (BinaryPolyMul.CLMUL.Prim.binaryPolyMulThunk 0xdead 0xbeef) ""
  putStrLn $ showHex (BinaryPolyMul.CLMUL.Prim.binaryPolyMulXMM 0xdead 0xbeef) ""
  ...
  putStrLn $ showHex (BinaryPolyMul.CLMUL.CFFI.Unsafe.binaryPolyMulXMM 0xdeadbeef12345678 0xc0ffee1234567890) ""
  ...
  putStrLn $ showHex (BinaryPolyMul.CLMUL.Prim.binaryPolyMulXMM 0xdeadbeef12345678 0xc0ffee1234567890) ""
